...
display_welcome() {
  ...
  echo -e "${WHITE}[+]                  © ⏤͟͟͞͞𝐕𝐗𝐓 || 𝗩𝗜𝗡𝗭𝗭𝗫                 [+]${NC}"
  echo -e "${BLUE}[+]                                                 [+]${NC}"
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e ""
...
check_token() {
  echo -e "                                                       "
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "${BLUE}[+]               LICENSY VINZZX DEVELOPER           [+]${NC}"
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
  echo -e "${YELLOW}MASUKAN AKSES TOKEN :${NC}"
  read -r USER_TOKEN

  if [ "$USER_TOKEN" = "vinzzx" ]; then
    echo -e "${GREEN}AKSES BERHASIL${NC}}"
  else
    echo -e "${GREEN}Buy dulu Gih Ke ⏤͟͟͞͞𝐕𝐗𝐓 || 𝗩𝗜𝗡𝗭𝗭𝗫 ${NC}"
    echo -e "${YELLOW}TELEGRAM : @vinzzxstore${NC}"
    echo -e "${YELLOW}WHATSAPP : 6287786436580${NC}"
    echo -e "${YELLOW}HARGA TOKEN : 10K FREE UPDATE JIKA ADA TOKEN BARU${NC}"
    echo -e "${YELLOW}©VinzzxDeveloper${NC}"
    exit 1
  fi
  clear
}
...
while true; do
  ...
  echo -e "${RED}'ggg      ,gg'''  .    ggg       Auto Installer VinzzxDeveloper Private   ${NC}"
  echo -e "${RED}gggg      gg     ,     ggg      ------------------------  ${NC}"
  echo -e "${WHITE}ggg:     gg.     -   ,ggg       • WhatsApp : 6285854642521    ${NC}"
  echo -e "${WHITE} ggg:     ggg._    _,ggg        • Credit  : ⏤͟͟͞͞𝐕𝐗𝐓 || 𝗩𝗜𝗡𝗭𝗭𝗫  ${NC}"
  echo -e "${WHITE} ggg.    '.'''ggggggp           • Support by ⏤͟͟͞͞𝐕𝐗𝐓 || 𝗩𝗜𝗡𝗭𝗭𝗫   ${NC}"
